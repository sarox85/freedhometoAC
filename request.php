...
$url = 'https://freedhomedev.api-us1.com';
...
$params = array(
    ...
    'api_key'      => '5a12a2640eebef8d1e708b318b1f68f86c59df48eec5ce5f5c277a8226844387f2c14f6a',
...
$post = array(
    ...
    'first_name'               => $nome,
    'last_name'                => $cognome,
    'phone'                    => $recapitoTelefonico,
    'customer_acct_name'       => $ragioneSociale,
    'tags'                     => '',
	
    //'ip4'                    => '127.0.0.1',	
	
    // any custom fields
    //'field[pm,0]'           => 55, // where 345 is the field ID
    'field[%ID%,0]'      			=> $idListaPM, // using the personalization tag instead (make sure to encode the key)
	'field[%BRAND%,0]'      		=> $brand,
	'field[%SEDELEGALE%,0]'     	=> $sedeLegale,
	'field[%PIVA%,0]'      			=> $PIVA,
	'field[%CF%,0]'      			=> $CF,
	'field[%CODICEUNIVOCO%,0]'  	=> $codiceUnivoco,
	'field[%PEC%,0]'      			=> $pec,
	'field[%CAPASSEGNATI%,0]'      => $cap,

	
	
    // assign to lists:
    'p[123]'                   => $lista, // example list ID (REPLACE '123' WITH ACTUAL LIST ID, IE: p[5] = 5)
